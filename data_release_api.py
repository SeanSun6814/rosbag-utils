...
if __name__ == '__main__':
    ...
    for i in range(n_data):
        ...
        assert len(file_list) > 0, "Number of bags in the data folder, \033[91m{}\033[0m should be non-zero".format(bagpath)
        ...
        res = rosbagutils.datasetRelease(file_list, pathout ,'test', topicMap, "link", start_time=start_timestamp, end_time=end_timestamp)
