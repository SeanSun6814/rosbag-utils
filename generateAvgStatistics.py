...
def processOdometry(paths, targetTopic, pathOut, sendProgress=None):
    sum_a = 0
    sum_angular_rate = 0
    prev_p = [0.0, 0.0, 0.0]
    prev_v = [0.0, 0.0, 0.0]
...
if __name__ == "__main__":
    ...
    parser.add_argument('--topic_name', default='/aft_mapped_to_init_imu',
                        help="topic name that contains the ground truth")
    ...
    processOdometry(sorted(full_path_list), args.topic_name, args.datapath)
