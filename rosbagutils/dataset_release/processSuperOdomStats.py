...
full_var_list = ["timestamp", "laserCloudSurfFromMapNum", "laserCloudCornerFromMapNum", "laserCloudSurfStackNum", "laserCloudCornerStackNum", "total_translation", "total_rotation",
                     ...
                     "PlaneInvalidNumerical",  "PlaneMSETOOLARGE",  "PlaneUnknown",  "PredictionSource", "meanSquareDistEdgeInlierNum", "meanSquareDistEdgeOutlierNum", "fitQualityCoeffEdgeInlierNum",
                     "fitQualityCoeffEdgeOutlierNum", "meanSquareDistPlaneInlierNum", "meanSquareDistPlaneOutlierNum", "fitQualityCoeffPlaneInlierNum", "fitQualityCoeffPlaneOutlierNum" ]
